    ...
    public void onClick(View view) {
        ...
        switch(view.getId()) {
            case R.id.btnAdd:
                ...
                tvresults.setText(String.valueOf(addition));
                break;
            case R.id.btnSubtract:
                int subtraction = Integer.parseInt(num1) - Integer.parseInt(num2);
                tvresults.setText(String.valueOf(subtraction));
                break;
            case R.id.btnDivide:
                try {
                    int division = Integer.parseInt(num1) / Integer.parseInt(num2);
                    tvresults.setText(String.valueOf(division));
                }catch(Exception e) {
                    tvresults.setText("Cannot DIVIDE!");
                }
                break;
            case R.id.btnMultiply:
                int multiply = Integer.parseInt(num1) * Integer.parseInt(num2);
                tvresults.setText(String.valueOf(multiply));
                break;
